"""Request builder for Logfare API (OpenAI-compatible chat completions)."""
...
def _apply_thinking_config(extra_body: dict[str, Any]) -> None:
    # Logfare/Google expects thinking config under a nested ``extra_body`` key.
...
def build_request_body(request_data: Any, *, thinking_enabled: bool) -> dict:
    """Build OpenAI-format request body from an Anthropic request for Logfare."""
    logger.debug(
        "LOGFARE_REQUEST: conversion start model={} msgs={}",
    ...
    logger.debug(
        "LOGFARE_REQUEST: conversion done model={} msgs={} tools={}",
        body.get("model"),
